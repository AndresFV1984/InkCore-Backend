...
@Schema(name = "OrderCreatePaymentSuccessEnvelope", description = "Abono/reversión con paymentNumber ABN-{n} "
        + "y accountsReceivable (cxcNumber + abonosNumber ABN-n + lastPaymentNumber)")
