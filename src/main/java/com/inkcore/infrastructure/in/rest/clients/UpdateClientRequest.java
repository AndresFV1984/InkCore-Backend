...
@Schema(
        ...
        description = """
                Actualización de cliente (PUT /api/v1/clients/update/{clientId}).
                Obligatorios: name, department, city, state.
                 Opcionales: documentType (CC|CE|TI|PA|NIT), identification, address, phone, email, contactPerson, creditDays (default 0).
