...
@Schema(
        name = "CreateFinishingProcessRequest",
        description = """
                Alta de proceso de acabado (POST /api/v1/finishing-processes/register).
                Obligatorios: companyId, name.
                Opcionales: minCost, valuePerCm2 (default 0), quickAccess (default false), state (default true).
                """
)
public record CreateFinishingProcessRequest(
        ...
        @Schema(description = "Valor por cm² (sin símbolo $; default 0; máx 9999)", example = "1200.00")
